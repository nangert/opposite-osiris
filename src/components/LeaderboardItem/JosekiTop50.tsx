...
const JosekiTop50 = ({ players }: Top50RankedProps) => {
    return (
        <>
                        ...
                        return (
                            <li>
                                <CustomLinkButton href={link}>
                                    <LeaderboardItem rank={key + 1} oldRank={""} username={player.username} blatmmr={player.rating} oldBlatmmr={""} />
                                </CustomLinkButton>
                                <a href={link}></a>
                            </li>
                        );
